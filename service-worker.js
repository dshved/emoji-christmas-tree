"use strict";
var precacheConfig = [
  ["index.html", "a1bdbc3a35d0394cceb4e5fc651f1a30"],
  ["static/css/main.2c377e4e.css", "3883f879ec35f9afd98d9a8e52a1497c"],
  ["static/js/main.f245e4dd.js", "87b0aef006142e9f04338a244fa4447b"]
],
  cacheName =
...
self.addEventListener("install", function(e) {
  ...
  if ("GET" === e.request.method) {
    ...
    !t &&
      ...
      ((n = new URL(a, self.location).toString()), (t = urlsToCacheKeys.has(
        n
      ))), t &&
      e.respondWith(
        caches
